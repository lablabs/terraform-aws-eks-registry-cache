...
[![pre-commit](https://github.com/lablabs/terraform-aws-eks-registry-cache/actions/workflows/pre-commit.yml/badge.svg)](https://github.com/lablabs/terraform-aws-eks-registry-cache/actions/workflows/pre-commit.yml)
...
| <a name="input_helm_chart_name"></a> [helm\_chart\_name](#input\_helm\_chart\_name) | Helm chart name to be installed | `string` | `"registry-cache"` | no |
...
| <a name="input_helm_release_name"></a> [helm\_release\_name](#input\_helm\_release\_name) | Helm release name | `string` | `"registry-cache"` | no |
...
| <a name="input_irsa_role_name_prefix"></a> [irsa\_role\_name\_prefix](#input\_irsa\_role\_name\_prefix) | The IRSA role name prefix for registry-cache | `string` | `"registry-cache-irsa"` | no |
| <a name="input_irsa_tags"></a> [irsa\_tags](#input\_irsa\_tags) | IRSA resources tags | `map(string)` | `{}` | no |
| <a name="input_namespace"></a> [namespace](#input\_namespace) | The K8s namespace in which the registry-cache service account has been created | `string` | `"registry-cache"` | no |
...
| <a name="input_service_account_name"></a> [service\_account\_name](#input\_service\_account\_name) | The k8s registry-cache service account name | `string` | `"registry-cache"` | no |
| <a name="input_settings"></a> [settings](#input\_settings) | Additional helm sets which will be passed to the Helm chart values, see https://hub.helm.sh/charts/stable/registry-cache | `map(any)` | `{}` | no |
| <a name="input_values"></a> [values](#input\_values) | Additional yaml encoded values which will be passed to the Helm chart, see https://hub.helm.sh/charts/stable/registry-cache | `string` | `""` | no |
...
| <a name="output_iam_role_attributes"></a> [iam\_role\_attributes](#output\_iam\_role\_attributes) | registry-cache IAM role atributes |
